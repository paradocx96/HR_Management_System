...
<html>
  <head>
    <meta charset="utf-8">
    <link rel="stylesheet" type="text/css" href="css/allemp.css">
    <script src="javaScript/allemp.js"></script>
...
<!--content-->
    ...
    <div class="div5">
      <table>
        <tr>
          <td width="85%"><H1>All Employee</H1></td>
          <td width="15%"><button onclick="location.href='addemp.php';" class="btn1" href="addemp.php">Add Employee</button></td>
        </tr>
      </table>
    </div>
